...
export const serviceDeskManifest: PlatformModuleManifest = {
  ...
  navigation: [
    { id: "service-desk", title: "Service Desk", path: "/service-desk", requiredPermissions: ["service_desk.access"] },
    { id: "my-tickets", title: "Мои заявки", path: "/service-desk/my-tickets", requiredPermissions: ["service_desk.access"] },
  ],
};
