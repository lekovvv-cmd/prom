...
export type ServiceDeskApprovalStatus =
  "pending" | "approved" | "rejected" | "skipped";
export type ServiceDeskAllowedAction =
  | "approve"
  | "reject"
  | "assign"
  | "reassign"
...
type ServiceDeskTicketApprovalStage = {
  id: string;
  ticket_id: string;
  position: number;
  title: string;
...
type ServiceDeskTicketFieldSnapshot = {
  key: string;
  label: string;
  type: string;
  raw_value: unknown;
...
export type ServiceDeskAttachment = {
  id: string;
  owner_type:
    "service_desk_ticket" | "service_desk_comment" | "service_desk_field_value";
  owner_id: string;
  ticket_id: string;
