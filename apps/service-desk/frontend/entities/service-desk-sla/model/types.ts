...
export type SlaPolicy = {
  ...
  pause_statuses: Array<"waiting_requester" | "waiting_external">;
};
export type SlaBindingConditionField =
  | "template_version_id"
  | "service_id"
  | "category_id"
  | "priority"
  | "field_value";
export type SlaBindingCondition = {
  field: SlaBindingConditionField;
  value: string;
  field_key?: string | null;
};
export type SlaBinding = {
  id: string;
  policy_id: string;
  name: string;
  priority: number;
...
export type EscalationActionType =
  "create_in_app_notification" | "email_notification_when_available";
export type EscalationRecipientType =
  "assignee" | "requester" | "service_desk_admin" | "specific_user";
...
export type EscalationRulePayload = Omit<
  EscalationRule,
  "id" | "sla_policy_id"
>;
