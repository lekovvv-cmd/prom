...
export function getAdminProjectStages(projectId: string) {
  return apiClient.request<ProjectStageWithTasks[]>(
    `/admin/projects/${projectId}/stages`,
  );
}

export function createAdminProjectStage(
  projectId: string,
  payload: ProjectStagePayload,
) {
  return apiClient.request<ProjectStage>(
    `/admin/projects/${projectId}/stages`,
    {
      method: "POST",
...
export function createAdminProjectTask(
  projectId: string,
...
export function updateAdminProjectTask(
  projectId: string,
  taskId: string,
  payload: Partial<ProjectTaskPayload>,
) {
  return apiClient.request<ProjectTask>(
...
export function updateMyProjectTaskStatus(
  taskId: string,
