        ...
        if (isMounted) {
          setError(
            err instanceof Error
              ? err.message
              : "Не удалось загрузить полугодовой отчёт",
          );
        }
      })
      .finally(() => {
    ...
    <Card className="report-card">
      ...
      {message && (
        ...
        >
          ...
          <div>
            ...
            <span>
              Можно вернуться в профиль и обновить отчёт до закрытия периода.
            </span>
          </div>
        </div>
      )}
      <form className="report-form" onSubmit={handleSubmit}>
        <Textarea
          ...
          onChange={(event) =>
            setForm({ ...form, completed_work: event.target.value })
          }
          required
        />
        <Textarea
          ...
          onChange={(event) =>
            setForm({ ...form, project_results: event.target.value })
          }
        />
        <Textarea
          ...
          onChange={(event) =>
            setForm({ ...form, competencies_used: event.target.value })
          }
        />
        <div className="form-grid">
          <Textarea
            ...
            onChange={(event) =>
              setForm({ ...form, difficulties: event.target.value })
            }
          />
          <Textarea
            ...
            onChange={(event) =>
              setForm({ ...form, next_period_plans: event.target.value })
            }
          />
        </div>
