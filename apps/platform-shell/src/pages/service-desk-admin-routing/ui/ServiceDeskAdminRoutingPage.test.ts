...
import { buildRoutingCategoryOptions, buildRoutingServiceOptions } from "./ServiceDeskAdminRoutingPage";

const categories: ServiceDeskCategory[] = [
  { id: "category-2", title: "Учебный процесс", description: null, parent_id: null, position: 0, is_active: true, deleted_at: null },
  { id: "category-1", title: "Администрирование", description: null, parent_id: null, position: 0, is_active: true, deleted_at: null }
];
