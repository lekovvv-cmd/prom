      ...
      {isModuleRoute ? <nav className="main-nav">
        {isServiceDeskRoute ? (
          <>
            ...
            {token && <NavLink to="/service-desk/workbench"><Archive size={15} aria-hidden="true" />Рабочее место</NavLink>}
          </>
        ) : (
          <>
        ...
        <div className="header-auth-actions">
          {token ? (
            ...
            <NavLink className="user-chip user-chip-link" to="/profile">
              <UserRound size={15} />
              <span>{isServiceDeskRoute ? "Пользователь Service Desk" : user ? roleLabels[user.role] : "Пользователь"}</span>
