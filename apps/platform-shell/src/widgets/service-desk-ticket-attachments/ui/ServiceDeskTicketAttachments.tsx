...
import { deleteServiceDeskAttachment, downloadServiceDeskAttachment, listServiceDeskAttachments, uploadServiceDeskTicketAttachment } from "../../../entities/service-desk-ticket/api/serviceDeskTicketApi";
...
export function ServiceDeskTicketAttachments({ ticketId, canUpload = true, canDelete = false, onChanged }: { ticketId: string; canUpload?: boolean; canDelete?: boolean; onChanged?: (attachments: ServiceDeskAttachment[]) => void }) {
