...
export const serviceDeskApiClient = createApiClient(env.serviceDeskApiBaseUrl, authTokenStorage);
export const accessApiClient = createApiClient(env.accessApiBaseUrl, authTokenStorage);
