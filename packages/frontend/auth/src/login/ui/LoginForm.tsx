...
const demoUsers = [
  {
    ...
    description: "Проекты, отклики и личный кабинет",
  },
  {
    label: "Руководитель проектов",
    email: "project.manager@utmn.ru",
    description: "Управление проектами и отчётностью",
  },
  {
    label: "Менеджер Service Desk",
    email: "sd.manager@utmn.ru",
    description: "каталог, заявки и рабочее место",
  },
  {
    label: "Администратор Service Desk",
    email: "sd.admin@utmn.ru",
    description: "Каталог, настройки и заявки",
  },
  {
    label: "Администратор платформы",
    email: "admin@utmn.ru",
    description: "Полный доступ к обоим модулям",
  },
];
  ...
  return (
    <form className="form-panel login-form" onSubmit={handleSubmit}>
      <div className="login-form-heading">
        ...
        <p>
          Для демо используется код подтверждения <strong>000000</strong>.
        </p>
      </div>
      <div
        className="role-switcher"
        role="group"
        aria-label="Демонстрационные роли"
      >
        {demoUsers.map((user) => (
          <button
            type="button"
