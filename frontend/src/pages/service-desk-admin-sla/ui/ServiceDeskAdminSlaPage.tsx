...
export function ServiceDeskAdminSlaPage() {
  ...
  return (
    <PageLayout title="SLA Service Desk" subtitle="Рабочие календари, политики, правила применения и правила эскалации." actions={<Button variant="secondary" onClick={() => void load()} disabled={loading}><RefreshCw size={16} /> Обновить</Button>}>
