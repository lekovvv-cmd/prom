...
export const createAdminTemplateField = (versionId: string, payload: { key: string; label: string; field_type: ServiceDeskTemplateFieldType; is_required: boolean; position: number; options?: Array<{ label: string; value: string }> }) => serviceDeskApiClient.request<ServiceDeskTemplateField>(`/admin/template-versions/${versionId}/fields`, { method: "POST", body: JSON.stringify(payload) });
