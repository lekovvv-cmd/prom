...
Скриншоты являются реальными скриншотами используемого ServiceDesk.

Агент должен просмотреть папку целиком, а не только изображения, на которые есть явные ссылки в этом ТЗ.

6. Составить внутреннюю таблицу соответствия:
...
7. Только после этого начинать реализацию.
